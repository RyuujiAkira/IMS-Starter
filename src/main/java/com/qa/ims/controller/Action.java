...
public enum Action {
	...
	RETURN("To return to domain selection"), ADDITEMORDER("To add an item to an entity already in the database"), 
	DELETEITEMORDER("To delete an item from an entity already in the database");
